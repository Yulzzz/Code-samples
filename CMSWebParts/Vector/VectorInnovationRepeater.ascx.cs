...
public partial class CMSWebParts_Vector_VectorInnovationRepeater : CMSAbstractWebPart
{
    ...
    public string RepeaterTitle
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("RepeaterTitle"), null);
        }
        set
        {
            SetValue("RepeaterTitle", value);
        }
    }
    ...
    protected void SetupControl()
    {
        switch (ViewMode)
        {
            ...
            case ViewModeEnum.EditNotCurrent:
                pnlInnovationRepeaterPreviewMode.Visible = false;
                return;
            default:
                pnlInnovationRepeaterPreviewMode.Visible = true;
                break;
        }
